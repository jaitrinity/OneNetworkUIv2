...
export class LoginComponent implements OnInit {
  ...
  changePassword(){
    if(this.newPassword == ""){
      ...
      let msg = "1). Password must be at least 8 characters.\n";
      msg += "2). Password must contain at least one letter.\n";
      msg += "3). Password must contain at least one digit.\n";
      msg += "4). Password must contain at least one (@) special charactor.";
      alert(msg)
      return;
    }
